...
namespace TheBugTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,ReturnUrl,Title,Message,Created,RecipientId,SenderId,Viewed")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,ReturnUrl,Title,Message,Created,RecipientId,SenderId,Viewed")] Notification notification)
        {
